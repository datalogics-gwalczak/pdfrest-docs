...
::field-group
  ...
  Required field for license-managed versions of the API Toolkit Container only. Cloud API service API Keys are _not_ License Keys. This setting also does not apply to the Toolkit on AWS.

  ::alert{type="secondary" icon="lucide:info"}
  We offer a Free Trial License Key to all accounts on [pdfRest.com](https://pdfrest.com/getstarted/). Existing account holders can generate a License Key from the [Container section of the Account page](https://pdfrest.com/account).
  :::
