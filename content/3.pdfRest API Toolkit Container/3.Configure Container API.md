...
::field-group
  ...
  Required field for license-managed versions of the API Toolkit Container only. Cloud API service API Keys are _not_ License Keys. This setting also does not apply to the Toolkit on AWS. Free Trial License Keys can be requested by following the link on the public [pdfRest Docker Hub repository](https://hub.docker.com/r/pdfrest/pdf-api-toolkit#getting-started).
  :::
