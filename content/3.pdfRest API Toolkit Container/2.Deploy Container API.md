...
The Container image and a Free Trial License Key can be obtained from the public [pdfRest Docker Hub repository](https://hub.docker.com/r/pdfrest/pdf-api-toolkit). 
...
- The `LICENSE_KEY` variable is required to properly license the server. Without setting this variable before deploying, pdfRest will run in a reduced capabilities mode.
