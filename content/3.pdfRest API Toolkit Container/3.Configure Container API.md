...
::field-group
  ...
  Required field for license-managed versions of the API Toolkit Container only. Does not apply to the Toolkit on AWS. Trial license keys and further information can be obtained by reaching out to the [Datalogics Sales](mailto:sales@datalogics.com) team.
  :::
...
ARG PDFREST_IMAGE=ghcr.io/cloud-innovation-team/pdfrest
