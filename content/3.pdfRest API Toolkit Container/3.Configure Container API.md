...
::field-group
  ...
  Required field for license-managed versions of the API Toolkit Container only. Cloud API service API Keys are _not_ License Keys. This setting also does not apply to the Toolkit on AWS. Use the [request form for a Free Trial License Key](https://pdfrest.com/container-license-key-request).
  :::
